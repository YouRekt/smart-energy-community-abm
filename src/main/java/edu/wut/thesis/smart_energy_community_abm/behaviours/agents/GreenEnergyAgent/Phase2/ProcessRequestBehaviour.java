package edu.wut.thesis.smart_energy_community_abm.behaviours.agents.GreenEnergyAgent.Phase2;

import edu.wut.thesis.smart_energy_community_abm.agents.GreenEnergyAgent;
import edu.wut.thesis.smart_energy_community_abm.behaviours.base.BaseMessageHandlerBehaviour;
import jade.lang.acl.ACLMessage;

public class ProcessRequestBehaviour extends BaseMessageHandlerBehaviour {
    private final GreenEnergyAgent agent;
    private boolean receivedRequest = false;

    public ProcessRequestBehaviour(GreenEnergyAgent agent) {
        super(agent);
        this.agent = agent;
    }
